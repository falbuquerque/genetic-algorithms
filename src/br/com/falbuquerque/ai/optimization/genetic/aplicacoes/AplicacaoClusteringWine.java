...
public interface AplicacaoClusteringWine extends AplicacaoAlgoritmoGenetico<Integer, Double> {
	 ...
	 */
	Alfabeto<Integer> ALFABETO = new AlfabetoClustering(new IntervaloInteiros(1, 3));
	 ...
	 */
	List<DadoCluster> DADOS = new LeitorArquivosCSV("/dev/tmp/ai/databases", "wine.csv").gerarDadosCluster();
}
