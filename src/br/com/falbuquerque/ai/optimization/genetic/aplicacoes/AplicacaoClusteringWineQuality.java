...
public interface AplicacaoClusteringWineQuality extends AplicacaoAlgoritmoGenetico<Integer, Double> {
	 ...
	 */
	Integer TAMANHO_POPULACAO = 120;

	/**
	 * Máximo de gerações que o algoritmo verificará
	 */
	Integer NUM_MAX_GERACOES = 500;
	 ...
	 */
	Alfabeto<Integer> ALFABETO = new AlfabetoClustering(new IntervaloInteiros(1, 7));
	 ...
	 */
	List<DadoCluster> DADOS = new LeitorArquivosCSV("/dev/tmp/ai/databases", "wine_quality.csv").gerarDadosCluster();
}
