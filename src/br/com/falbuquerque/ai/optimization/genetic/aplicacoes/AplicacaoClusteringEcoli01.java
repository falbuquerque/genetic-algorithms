...
public class AplicacaoClusteringEcoli01 implements AplicacaoClusteringEcoli {
	...
	public void executarAlgoritmo(final List<Individuo<Integer, Double>> populacaoInicial,
		...
		for (int execucao = 0; execucao < 1; execucao++) {
			...
			try {
				...
				aux.resumirDadosGeracoes(AplicacaoClusteringEcoli.NUM_MAX_GERACOES, execucao);
				aux.encontrarMelhorIndividuo(AplicacaoClusteringEcoli.NUM_MAX_GERACOES, execucao);
